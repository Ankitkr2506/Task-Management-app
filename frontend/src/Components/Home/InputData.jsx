...
const InputData = ({ InputDiv, setInputDiv, UpdatedData, setUpdatedData }) => {
  ...
  const submitData = async () => {
    if (Data.title === "" || Data.desc === "") {
      ...
      try {
        const response = await axios.post("https://task-management-app-nine-ashen.vercel.app/api/v2/create-task", Data, { headers });
 ...
 const UpdateTask = async ()=>{
  if (Data.title === "" || Data.desc === "") {
    ...
    try {
      await axios.put(`https://task-management-app-nine-ashen.vercel.app/api/v2/update-task/${UpdatedData.id}`, Data, { headers });
      setUpdatedData({
        id: "",
        title: "",
        desc:"",
